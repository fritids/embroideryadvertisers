...
<div class="login profile" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form id="your-profile" action="<?php $template->the_action_url( 'profile' ); ?>" method="post">
		...
		<tr>
			...
			<td><textarea name="description" id="description" rows="8" cols="65"><?php echo esc_html( $profileuser->description ); ?></textarea><br />
		...
		<p class="submit">
			...
			<input type="submit" class="button-primary button" value="<?php esc_attr_e( 'Update Profile' ); ?>" name="submit" />
		</p>
	</form>
	<a href="http://embroideryadvertisers.com/?event=delete_account" style="float:right;">Delete your account</a>
