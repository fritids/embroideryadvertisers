...
<td><input type="checkbox" name="eStore_use_wp_mail" value="1" '.$eStore_use_wp_mail.' /><span class="description"> If checked the plugin will use the WordPress mail function to send emails. Otherwise it will use a simple PHP mail script that comes with this plugin.</span></td>
</tr>

<tr valign="top">
<th scope="row">Send Emails to Buyer After Purchase</th>
<td><input type="checkbox" name="eStore_send_buyer_email" value="1" '.$eStore_send_buyer_email.' /><span class="description"> If checked the plugin will send an email to the buyer with the sale details. If digital goods are purchased then the email will contain encrypted download links for the downloadable products.</a></span></td>
</tr>

<tr valign="top">
<th scope="row">From Email Address*</th>
<td><input type="text" name="eStore_download_email_address" value="'.$eStore_download_email_address.'" size="50" />
...
<td><input type="text" name="eStore_buyer_email_subj" value="'.$eStore_buyer_email_subj.'" size="50" />
...
<td><textarea name="eStore_buyer_email_body" rows="7" cols="70">'.$eStore_buyer_email_body.'</textarea>
...
<td><input type="text" name="eStore_notify_email_address" value="'.$eStore_notify_email_address.'" size="50" />
...
<td><input type="text" name="eStore_seller_email_subj" value="'.$eStore_seller_email_subj.'" size="50" />
...
<td><textarea name="eStore_seller_email_body" rows="7" cols="70">'.$eStore_seller_email_body.'</textarea>
<br /><p class="description">This is the body of the email that will be sent to the seller for record. Do not change the text withing the braces {}. All the available <a href="http://www.tipsandtricks-hq.com/ecommerce/?p=460#email_tags" target="_blank">email tags are listed here</a></p></td>
</tr>

<tr valign="top">
<th scope="row">Append Buyer Email and Payment Parameters to Admin Email</th>
<td><input type="checkbox" name="eStore_add_payment_parameters_to_admin_email" value="1" '.$eStore_add_payment_parameters_to_admin_email.' />
