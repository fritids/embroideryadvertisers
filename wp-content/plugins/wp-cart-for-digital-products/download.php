...
//TODO - Check product specific link expiry settings
...
if($download_url_limit_count && $download_url_limit_count!= "999") {// Download limit counting is enabled
	$eStore_debug_manager->downloads("Download limit counting is enabled. Limit: ".$download_url_limit_count." Access count: ".$current_access_count, ESTORE_LEVEL_STATUS);
