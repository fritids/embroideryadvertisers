...
class eStore_dbgmgradm {
	...
	// -- The Assurer, 2010-10-18.
		...
		$html_code = '<table class="form-table">';
			...
			$html_code .= '<div class="submit"><input type="submit" name="reset_logfiles" style="font-weight:bold; color:red" value="Reset Debug Log files"/> All of the above debug log files are "reset" and timestamped with a log file reset message.</div></td></tr>';
