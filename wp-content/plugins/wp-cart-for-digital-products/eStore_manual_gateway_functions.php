		...
		if (isset($_POST['submit_shipping']))
        {
			...
			else
			{
    	            ...
    	            foreach ($_SESSION['eStore_cart'] as $item)
    	            {
    	                ...
    	                $body .= "\n".ESTORE_PRICE.": ".print_digi_cart_payment_currency($rounded_price,$curr_symbol);
    	                ...
    	                if(get_option('eStore_manual_co_give_download_links')!='')
    	                {
            				...
            				$body .= eStore_post_sale_retrieve_serial_key_and_update($retrieved_product,$item['name'],$item['quantity']);
