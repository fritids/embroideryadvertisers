...
function wp_eStore_payment_gateway_settings()
{
    ...
    <br /><p class="description">When checked the plugin will give the customer an option to select a payment method (eg. PayPal, 2Checkout, Manual).</p>
    </td></tr>
    ...
    <br /><p class="description">When checked the customers will be able to checkout using <a href="http://www.2checkout.com/?affiliate=1385310" target="_blank">2Checkout</a>.</p>
    </td></tr>
    ...
    <br /><p class="description">Your 2Checkout Secret Word. <a href="http://www.2checkout.com/community/blog/knowledge-base/suppliers/tech-support/3rd-party-carts/md5-hash-checking/where-do-i-set-up-the-secret-word" target="_blank">How to find the secret word?</a></p>
    </td></tr>
    ...
    <br /><p class="description">When checked the customers will be able to checkout using <a href="http://www.authorize.net/" target="_blank">Authorize.net</a>.</p>
    </td></tr>
