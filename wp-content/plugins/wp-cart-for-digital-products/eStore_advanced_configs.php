...
define('WP_ESTORE_ENABLE_NEW_CHECKOUT_REDIRECTION', '0'); //Set it to 1 to enable this
...
define('WP_ESTORE_USE_ANCHOR_FOR_THANKU_DL_LINKS', '0');//Set it to 1 to enable this
...
define('WP_ESTORE_ENABLE_AJAX_ON_ADD_TO_CART_BUTTONS', '0'); //Set it to 1 to enable this
...
define('WP_ESTORE_SHOW_CURRENCY_SYMBOL_AFTER_AMOUNT', '0');//Set it to 1 to enable this
