...
'sidetable'		=> "	background-color: #ffffff !important;
				padding:10px;
				color:#000;
				border: 2px solid #6D8C82;
				margin-bottom: 8px;
				width:100%;
				",
'sidelink'		=> "  font-family:verdana,geneva,Sans-Serif;
				font-size:11px;
				font-weight:bold;
				color:#6D8C82;
