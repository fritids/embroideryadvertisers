...
define("EMEMBER_EMAIL_TAKEN", "כתובת האימייל בשימוש! 
אנא בחר כתובת אימייל אחרת. ");
define("EMEMBER_REG_COMPLETE", "ההרשמה הושלמה בהצלחה!");
...
define("EMEMBER_IP_BLACKLISTED","כתובת איי.פי זו חסומה. 
לא ניתן להירשם. 
צור קשר עם הנהלת האתר.");
/***added v5.0.7#end**/
/***added v5.3.4#start**/
...
/***added v7.5.4#end**/
/***added v7.6.2#start**/
define('EMEMBER_MR','מר');
define('EMEMBER_MRS','גב');
define('EMEMBER_MISS','Miss');
define('EMEMBER_MS','Ms');
define('EMEMBER_DR','דר');
define('EMEMBER_COMMENT_PROTECTED','<div class="eMember_comment_section_protected_msg">אזור התגובות מוגן</div>');
/***added v7.6.2#end**/
/***added v7.8.4#start**/
define('EMEMBER_ACCOUNT_PROFILE_NOT_ALLOWED','לפרופיל שלך אין גישה לתוכן זה.');
/***added v7.8.4#end**/
/***added v7.9.8.4#start**/
define('EMEMBER_SEARCH_TERM', 'ביטוי החיפוש');
define('EMEMBER_PREV', 'הקודם');
define('EMEMBER_NEXT', 'הבא');
define('EMEMBER_SEARCH', 'חיפוש');
define('EMEMBER_DATA_NOT_FOUND', 'לא נמצא מידע.');
define('EMEMBER_ALREADY_LOGGED_IN','הוצאת מהמערכת בכיוון שמשתמש אחר נכנס לתוך החשבון הזה מסייר אחר.');
define('EMEMBER_WELCOME_PAGE', 'דך ברוכים הבאים');
/***added v7.9.8.4#end**/
/***added v7.9.8.9 #start**/
define('EMEMBER_REMOVE', "להסיר");
define('EMEMBER_UPLOAD', 'להעלות');
define('EMEMBER_ACTION', 'פעולה');
define('EMEMBER_DETAILS','פרטים');
define('EMEMBER_MEMBER_SINCE','חבר מאז');
define('EMEMBER_DELETE_ACC','למחוק חשבון');
define('EMEMBER_USER','משתמש');
define('EMEMBER_USERS','משתמשים');
/***added v7.9.8.9 #end**/
/***added v8.1.4 #start**/
