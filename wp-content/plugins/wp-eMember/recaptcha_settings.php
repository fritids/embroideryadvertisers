...
function recaptcha_settings()
{
    ...
    $msg = null;
	echo '<div class="wrap"><h3>WP eMembers - reCAPTCHA &trade; Settings</h3>';
...
?>  
    ...
    <td align="left">
    <input name="emember_enable_recaptcha" type="checkbox"  <?php $enable_captcha = $emember_config->getValue('emember_enable_recaptcha');echo ($enable_captcha)?'checked="checked"':''?> value="1"/>
