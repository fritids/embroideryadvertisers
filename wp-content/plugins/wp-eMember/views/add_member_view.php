...
/* <![CDATA[ */           
    jQuery(document).ready(function($){       
        <?php echo include_once(WP_EMEMBER_PATH.'/js/emember_js_form_validation_rules.php');?>        
...
<td>
    ...
    if (isset($_GET['editrecord'])&&($_GET['editrecord']!='')){
	    ...
	    ?>
	    <input name="user_name" class="validate[required,custom[onlyLetterNumberUnderscore],minSize[4],ajax[ajaxUserCall]]" type="text" id="user_name" value="<?php echo stripslashes(isset($editingrecord['user_name'])?$editingrecord['user_name']:""); ?>" size="53" />
...
<?php endif;?>
<tr valign="top">
    <th scope="row"><?php _e('Account State', 'wp_eMember'); 
...
<tr valign="top">
    ...
    <td><input name="country" type="text" id="country" value="<?php echo stripslashes(isset($editingrecord['country'])?$editingrecord['country']:""); ?>" size="53" /></td>
</tr>
<tr valign="top">
...
<tr valign="top">
    <th scope="row"><?php _e('Gender', 'wp_eMember'); 
...
<p class="submit">
   <input type="submit" name="Submit" value="<?php _e('Save Member Info', 'wp_eMember'); ?>" /> &nbsp; <?php if (isset($_GET['editrecord'])&&($_GET['editrecord']!='')) { ?>
...
jQuery(document).ready(function($){
    ...
    <?php if(isset($_GET['editrecord'])&&($_GET['editrecord']!='')&&empty($use_gravatar)) { 
    if($emember_config->getValue('eMember_profile_thumbnail')):
    ?>
