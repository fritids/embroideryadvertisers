...
<tbody>
	<?php $c=0; foreach($filtered_categories as $category):?>
	<tr <?php echo ($c%2)?'class="alternate"':"";?>>
		<th scope="row" class="check-column"><input class="emember_select" <?php echo $category['protected'];?> type="checkbox" name="checked[<?echo $category['ID'];?>]"></th>
