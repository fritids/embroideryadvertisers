...
function wp_eMember_general_settings()
{
	    ...
	    <div class="inside">
		    <table width="100%" border="0" cellspacing="0" cellpadding="6">
			    ...
			    <tr valign="top">
			    	...
			    	<td align="left">
				    	<input name="eMember_free_members_must_confirm_email" type="checkbox"  <?php $eMember_free_members_must_confirm_email = $emember_config->getValue('eMember_free_members_must_confirm_email');echo ($eMember_free_members_must_confirm_email)?'checked="checked"':''?> value="1"/><br />
		    	...
		    	<tr valign="top">
		    		...
		    		<td align="left">
		    			<input name="eMember_manually_approve_member_registration" type="checkbox"  <?php $eMember_manually_approve_member_registration = $emember_config->getValue('eMember_manually_approve_member_registration');echo ($eMember_manually_approve_member_registration)?'checked="checked"':''?> value="1"/><br />
		    			<i>If you want to manually approve the member after they register then check this option. A member's account will be "Inactive" after registration and the member will not be able to log in until you manually set the status to "Active".</i><br /><br />
			        </td>
                </tr>
		    	...
		    	<tr valign="top">
		    		...
		    		<td align="left">
		    			<input name="eMember_member_can_comment_only" type="checkbox"  <?php $eMember_member_can_comment_only = $emember_config->getValue('eMember_member_can_comment_only');echo ($eMember_member_can_comment_only)?'checked="checked"':''?> value="1"/><br />
		    	...
		    	<tr valign="top">
		    		...
		    		<td align="left">
		    			<input name="eMember_google_first_click_free" type="checkbox"  <?php $eMember_google_first_click_free = $emember_config->getValue('eMember_google_first_click_free');echo ($eMember_google_first_click_free)?'checked="checked"':''?> value="1"/><br />
		    	...
		    	<tr valign="top">
		    		...
		    		<td align="left">
		    			<input name="eMember_format_post_page_protected_msg" type="checkbox"  <?php $eMember_format_post_page_protected_msg = $emember_config->getValue('eMember_format_post_page_protected_msg');echo ($eMember_format_post_page_protected_msg)?'checked="checked"':''?> value="1"/><br />
		    	...
		    	<tr valign="top">
		    		...
		    		<td align="left">
		    			<input name="eMember_turn_off_protected_msg_formatting" type="checkbox"  <?php $eMember_turn_off_protected_msg_formatting = $emember_config->getValue('eMember_turn_off_protected_msg_formatting');echo ($eMember_turn_off_protected_msg_formatting)?'checked="checked"':''?> value="1"/><br />
	...
	<div class="inside">
		<table width="100%" border="0" cellspacing="0" cellpadding="6">
			    ...
			    <tr valign="top">
			    	...
			    	<td align="left">
			    		<input name="eMember_enable_auto_login_after_rego" type="checkbox"  <?php $eMember_enable_auto_login_after_rego = $emember_config->getValue('eMember_enable_auto_login_after_rego');echo ($eMember_enable_auto_login_after_rego)?'checked="checked"':''?> value="1"/><br />
			    ...
			    <tr valign="top">
			    	...
			    	<td align="left">
						<input name="eMember_show_link_to_after_login_page" type="checkbox"  <?php $eMember_show_link_to_after_login_page = $emember_config->getValue('eMember_show_link_to_after_login_page');echo ($eMember_show_link_to_after_login_page)?'checked="checked"':''?> value="1"/><br />
                ...
                <tr valign="top">
                    ...
                    <td align="left">
                        <input id="eMember_enable_fancy_login" name="eMember_enable_fancy_login" type="checkbox"  <?php $eMember_enable_fancy_login = $emember_config->getValue('eMember_enable_fancy_login');echo ($eMember_enable_fancy_login)?'checked="checked"':''?> value="<?php echo empty($eMember_enable_fancy_login)? 1: $eMember_enable_fancy_login; ?>"/>
                        use
			    ...
			    <tr valign="top">
			    	...
			    	<td align="left">
						<input name="eMember_disable_inline_login" type="checkbox"  <?php $eMember_disable_inline_login = $emember_config->getValue('eMember_disable_inline_login');echo ($eMember_disable_inline_login)?'checked="checked"':''?> value="1"/><br />
		    	...
		    	<tr valign="top">
		    		<td width="25%" align="left">
		    			<strong>Logout the Member After XX Minutes:</strong>
		    		</td>
		    		<td align="left">
		    			...
		    			<i>Use this option if you want to force your members to re-authenticate after XX minutes of browsing. 0 or empty value  means the feature is disabled.</i><br /><br />
			        </td>
                </tr>
		    	<tr valign="top">
		    		<td width="25%" align="left">
		    		...
		    		<td align="left">
		    			<input name="eMember_multiple_logins" type="checkbox"  <?php $eMember_multiple_logins = $emember_config->getValue('eMember_multiple_logins');echo ($eMember_multiple_logins)?'checked="checked"':''?> value="1"/><br />
		    			<i>Check this option to disable simultaneous member login using the same member account details (two users cannot log-in to the same account at the same time). The <code>Remember me</code> feature of the login form will be disabled when this feature is enabled.</i><br /><br />
			        </td>
                </tr>                		    			                 		    			    		    
    	</table>            
	</div>
		    ...
		    <table width="100%" border="0" cellspacing="0" cellpadding="6">
			    <tr valign="top">
                 ...
                 <tr>
                    ...
                    <td align="left"><input name="eMember_enable_bookmark_for_loggedin" type="checkbox"  <?php $enable_bookmark_loggedin = $emember_config->getValue('eMember_enable_bookmark_for_loggedin');echo ($enable_bookmark_loggedin)?'checked="checked"':''?> value="1"/> Show bookmark feature ONLY to members who are logged-in</td>
                 </tr>                 
   ...
   <!-- <div class="title"><label for="title">WordPress User Integration Settings (Only use this if you want to integrate the member's of WP eMember with your WordPress users)</label></div> -->
    	...
    	<div class="inside">
		    <table width="100%" border="0" cellspacing="0" cellpadding="6">
		    	...
		    	<tr valign="top">
		    		...
		    		<td align="left">
		    			<input name="eMember_preserve_wp_user_role" type="checkbox"  <?php $eMember_preserve_wp_user_role = $emember_config->getValue('eMember_preserve_wp_user_role');echo ($eMember_preserve_wp_user_role)?'checked="checked"':''?> value="1"/><br />
	    ...
	    <strong><i>Read the <a href="http://www.tipsandtricks-hq.com/wordpress-membership/?p=342" target="_blank">site wide protection feature</a> documentation before using this feature.</i></strong><br /><br />	    
		    <table width="100%" border="0" cellspacing="0" cellpadding="6">
                <tr valign="top">
                    ...
                    <td align="left">
                        <input name="eMember_enable_domain_lockdown" type="radio"  <?php $eMember_enable_domain_lockdown = $emember_config->getValue('eMember_enable_domain_lockdown');echo ($eMember_enable_domain_lockdown == 0)?'checked="checked"':''?> value="0"/>
                ...
                <tr valign="top">
                    <td width="25%" align="left"></td>
                    <td align="left">
                        <input name="eMember_enable_domain_lockdown" type="radio"  <?php $eMember_enable_domain_lockdown = $emember_config->getValue('eMember_enable_domain_lockdown');echo ($eMember_enable_domain_lockdown == 1)?'checked="checked"':''?> value="1"/>
                ...
                <tr valign="top">
                    <td width="25%" align="left"></td>
                    <td align="left">
                        <input name="eMember_enable_domain_lockdown" type="radio"  <?php $eMember_enable_domain_lockdown = $emember_config->getValue('eMember_enable_domain_lockdown');echo ($eMember_enable_domain_lockdown == 2)?'checked="checked"':''?> value="2"/>
    ...
    <input type="checkbox" name="wp_eMember_enable_remote_post" <?php $wp_eMember_enable_remote_post = $emember_config->getValue('wp_eMember_enable_remote_post');echo ($wp_eMember_enable_remote_post)?'checked="checked"':''?> value="1" />
		    ...
		    <table width="100%" border="0" cellspacing="0" cellpadding="6">
		    	<tr valign="top">
		    		...
		    		<td align="left">
		    			...
		    			<div class="submit"><input type="submit" name="wp_emember_reset_logfile" style="font-weight:bold; color:red" value="Reset Debug Log Files"/> All of the above debug log files are "reset" and timestamped with a log file reset message.</div>
			        </td>
                </tr>
		    	<tr valign="top">
		    		<td width="25%" align="left">
