...
/******/
    ...
    if (empty($eMember_before_expiry_num_days))
    {
	...
	<div class="wrap"><h3>WP eMembers - Email Settings</h3>
		<div id="poststuff">
			<div id="post-body">
					...
					<br /><strong>Enable the Auto Expiry Email Notification feature from the <a href="admin.php?page=eMember_settings_menu" target="_blank">Settings Page</a> if you want to use this feature</strong><br /><br />
					    <table width="100%" border="0" cellspacing="0" cellpadding="6">
							<tr valign="top">
							    ...
							    <td align="left">
							    	<input name="eMember_before_expiry_num_days" type="text" size="60" value="<?php echo $eMember_before_expiry_num_days; ?>"/>
							    	<br /><br />
							    </td>
						    </tr>					    
						    <tr valign="top">
