...
class WP_eMember_List_Table {
	...
	function ajax_user_can() {
		die( 'function WP_eMember_List_Table::ajax_user_can() must be over-ridden in a sub-class.' );
	}

	function prepare_items() {
		die( 'function WP_eMember_List_Table::prepare_items() must be over-ridden in a sub-class.' );
	}
...
<?php
	...
	function get_columns() {
		die( 'function WP_eMember_List_Table::get_columns() must be over-ridden in a sub-class.' );
	}
