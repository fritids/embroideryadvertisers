...
{	
	...
	<input type="checkbox" name="emember_download_folder_protection" id="emember_download_folder_protection"  <?php $protect_download = $emember_config->getValue('emember_download_folder_protection');echo ($protect_download)?'checked="checked"':''?> value="1" />
