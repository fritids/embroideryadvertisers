...
function wp_eMember_dashboard()
{
   ...
   <li><a href="admin.php?page=wp_eMember_manage">Members</a></li>
   <li><a href="admin.php?page=eMember_membership_level_menu">Membership Levels</a></li>
   <li><a href="admin.php?page=eMember_settings_menu">Settings</a></li>
   </ul>
   <?php
