                   	    ...
                   	    <strong><i>Fields to be shown on the Registation form (Username, Password and Email address are mandatory fields and will always be present on the form).</i></strong><br /><br />
                   		    <table width="100%" border="0" cellspacing="0" cellpadding="6">    
                   		    	...
                   		    	<tr valign="top">
                   		    		...
                   		    		<td align="left">
                   		    			<input name="eMember_reg_phone" type="checkbox"  <?php $eMember_reg_phone = $emember_config->getValue('eMember_reg_phone');echo ($eMember_reg_phone)?'checked="checked"':''?> value="1"/> Show phone field on registration page<br />  
                   		    			<input name="eMember_reg_phone_required" type="checkbox"  <?php $eMember_reg_phone = $emember_config->getValue('eMember_reg_phone_required');echo ($eMember_reg_phone)?'checked="checked"':''?> value="1"/> Make this field required
                   		    			<br /><br />
                   				    </td>
                   				</tr>        
