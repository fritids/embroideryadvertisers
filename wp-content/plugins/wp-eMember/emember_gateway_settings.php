...
{
	echo '<div class="wrap"><h3>WP eMember - Payment Gateway Settings</h3>';
...
?>    
	...
	<input type="submit" name="emem_generate_av_code" value="Generate Code" />
	</form>
    ...
    <div class="submit">
    <input type="submit" name="info_update_emem_cb" value="<?php _e('Save Clickbank options'); ?> &raquo;" />
    </div>
    </form>
    </div></div>
