...
//        die();
        ...
        if(isset($_POST['emember_field_flag']))$fields['emember_field_flag'] = $_POST['emember_field_flag'];
    ...
    if($emember_config->getValue('eMember_custom_field') == ''){//custom field settings is not enabled
        echo '<div class="wrap"><h3>WP eMember - Custom Fields Settings</h3>';
   ...
   ;(function($){
		$(document).ready(function(){
			...
			$('form').submit(function(){
                ...
                if(!$ok) alert('"Display Order" and "Field Name" field(s) cannot be kept empty.');
				return $ok;
			});
