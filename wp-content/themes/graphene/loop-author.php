    ...
    <div class="entry author-entry clearfix">
        ...
        <div <?php graphene_grid( 'entry-content clearfix', 13, 8, 5 ); ?>>
            ...
            <p>
				...
				<?php if ( get_the_author_meta( 'user_email' ) != '' ) {echo '<br />';printf( '<strong>Email:</strong> %1$s', '<a href="mailto:'.get_the_author_meta( 'user_email' ).'">'.get_the_author_meta( 'user_email' ).'</a>' );} ?>
